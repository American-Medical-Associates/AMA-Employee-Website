        ...
        <div className="my-5">
          <div className="flex justify-center items-center mb-3">
            ...
            <MenuItem
              ...
              onClick={() => { router.push('/NewPatientPacket') }}
            />
            <MenuItem
              icon={<ClipboardDocumentListIcon className="h-10 w-7 cursor-pointer text-black duration-[500s] ease-in" />}
              text="Submissions"
              onClick={() => { router.push('/NewPatientPacketSubmissions') }}
            />
            <MenuItem
              icon={<ChartBarIcon className="h-10 w-7 cursor-pointer text-black duration-[500s] ease-in" />}
              text="NPP Analytics"
              onClick={() => { router.push('/NewPatientPacketAnalytics') }}
            />
            <MenuItem
              icon={<ClipboardDocumentListIcon className="h-10 w-7 cursor-pointer text-black duration-[500s] ease-in" />}
              text="Booked Appointments"
              onClick={() => { router.push('/BookedAppointments') }}
            />
          </div>
          <div className="flex justify-center items-center">
            <MenuItem
              ...
              onClick={() => { router.push('/WeightLossSurvey') }}
            />
        ...
        <div className="my-5">
          <div className="flex justify-center items-center mb-3">
            ...
            <MenuItem
              ...
              onClick={() => { router.push('/MentalHealthQuestionnaire') }}
            />
            <MenuItem
              icon={<ClipboardDocumentListIcon className="h-10 w-7 cursor-pointer text-black duration-[500s] ease-in" />}
        ...
        <div className="my-5">
          <div className="flex justify-center items-center">
            ...
            <MenuItem
              ...
              onClick={() => { router.push('/VitalizeNation/VitalizeBookAnAppointment') }}
            />
            <MenuItem
              icon={<ClipboardIcon className="h-10 w-7 cursor-pointer text-black duration-[500s] ease-in" />}
              text="PDF Signatures"
              onClick={() => { router.push('/PdfSignatures') }}
            />
            {/* Add more buttons here if necessary */}
          </div>
        </div>
