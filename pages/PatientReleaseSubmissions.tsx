...
function PatientReleaseSubmissions() {
  // State declarations
    ...
    const fetchSubmissions = async () => {
      try {
        ...
        const submissionsData = querySnapshot.docs.map((doc) => {
          ...
          return {
            ...data,
            patientDOB: formatDate(data.patientDOB),
  ...
  const filteredSubmissions = submissions.filter(
    (submission) =>
      ...
      submission.patientDOB.includes(searchTerm),
  ...
  const handleRowClick = (submissionId: string) => {
    router.push(`/DynamicPatientReleaseForm/${submissionId}`)
  }
...
export default PatientReleaseSubmissions
