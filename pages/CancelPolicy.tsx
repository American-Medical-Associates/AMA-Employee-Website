...
function CancelPolicy() {
  ...
  const handleSubmit = () => {
    ...
    if (!patientName || dateOfBirth.day === '' || dateOfBirth.month === '' || dateOfBirth.year === '' || !date || !signature) {
  ...
  return (
    <div>
      ...
      <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8 mt-8 space-y-6">
        ...
        <p>Each time a patient misses an appointment without providing proper notice, another patient is prevented from receiving care. You <strong>MUST</strong> give our office 24 hour notice prior to your scheduled appointment. Calling the day of your scheduled appointment will result in a "No Show" fee.</p>
        <p>Mulitple No Shows in any 12-month period may result in termination of services with the provider. No Show fees will be billed to the patient. This fee is not covered by any insurance plan and will be your responsibility. Cancellation/No Show fees will have to be paid in order to continue services with Christina. If an appointment is made any fees incurred must be paid prior to the visit.</p>
        <p className="text-center"><strong><i>$100 - Charge for missed appointments or appointments cancelled with less than 24-hour notice.</i></strong></p>
        <p><strong>By signing below, I acknowledge that I have read and understand the cancellation policy of American Medical Associates and agree to the policy set forth.</strong></p>
        <div className="flex flex-wrap justify-between gap-4">
          <div className="flex-1 min-w-[290px]">
            <label htmlFor="facility" className="block text-lg text-gray-700 mb-2">
              Printed Name:
            </label>
            <input
              id="facility"
          ...
          <div className="flex-1 min-w-[290px]">
            <label htmlFor="signature" className="block text-lg text-gray-700 mb-2">
              Signature:
            </label>
            <input
              id="signature"
