        ...
        <form>
          ...
          <div className=" my-12 flex w-full flex-col items-center justify-center">
            ...
            <div className=" px-40">
              ...
              <ItemPicker
                ...
                options={[
                  ...
                  <option value="More then 12 weeks">
                    More then 12 weeks
                  </option>,
                ]}
              />
              <h5 className=" my-5 text-lg">
                ...
                for employment with American Medical Associates?
              </h5>
              ...
              <h5 className=" my-5 text-lg">
                Have you previously been employed by American Medical
                Associates?
              </h5>
              ...
              <p className=" text-lg">
                ...
                period of my employment. 2. I understand and agree that, if I am
                offered a position, it will be offered on condition that my
                employment will be at will and for no definite period, and that
                my employment may be terminated, at any time, with or without
                cause and with or without prior notice. 3. I understand that no
                supervisor or manager may alter or amend the above conditions
              ...
              <div className=" m-12 flex flex-row justify-center self-center">
                ...
                />
                I have read and understand the statements above and accept them
            ...
            <LineDivider
              ...
              margin={'my-20'}
            />
            <EmployeeOpportunitiesDisclosure
              setScrollState={setScrollComplete}
            />
            <div className=" m-12 flex flex-row justify-center self-center">
              <CheckBox
