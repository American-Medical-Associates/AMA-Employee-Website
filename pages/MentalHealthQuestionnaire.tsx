...
const [requiredInsuranceCoverage, setRequiredInsuranceCoverage] = useState(false)
...
const [requiredSessionLength, setRequiredSessionLength] = useState(false)
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <div className="mt-5">
        <div className='text-4xl text-center mb-5'>Mental Health Survey</div>

        <div className="mb-5 ml-5 text-2xl text-[#616161]">What's your age and gender?</div>
        <div className='flex'>
            <TextInput
                id='gender' 
                placeHolder='Gender'
                widthPercentage='w-2/4'
                onChange={(text: any) => {setGender(text.target.value)}}
      ...
      <MainButton 
        onClick = {() => {
            ...
            if (age === '') {
                ...
                router.push('/MentalHealthQuestionnaire/#CurrentClientYesNo').then(() => {
                    setTimeout(() => {
                        window.scrollBy(0, -150)
                    }, 100)
                })
                ...
                router.push('/MentalHealthQuestionnaire/#sessionLength').then(() => {
                    setTimeout(() => {
                        window.scrollBy(0, -150)
                    }, 100)
                })
                ...
                router.push('/MentalHealthQuestionnaire/#insuranceCoverage').then(() => {
                    setTimeout(() => {
                        window.scrollBy(0, -150)
                    }, 100)
                })
