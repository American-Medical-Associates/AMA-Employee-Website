...
export default function Datepicker({
  ...
  return (
    <div className=" flex h-[100px] w-[300px] items-center justify-center rounded-[30px] bg-[#cacaca71]">
            ...
            <div className="mb-5 w-64">
              ...
              <div className="relative">
                ...
                <input
                  type="text"
                  readOnly
                  className="focus:shadow-outline w-full cursor-pointer rounded-[30px] py-3 pl-4 pr-10 font-medium leading-none text-gray-600 shadow-sm focus:outline-none"
                ...
                {showDatepicker && (
                  <div
                    className="absolute top-0 left-0 mt-12 rounded-[30px] bg-white p-4 shadow-2xl"
                    style={{ width: '17rem' }}
                  >
