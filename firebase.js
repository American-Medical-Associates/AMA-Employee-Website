...
//   medicationsTakenList,
// }) {
//   await setDoc(doc(db, 'companys', 'AMA', 'patients', emailValue, 'WeightLoss', emailValue), {
//     emailValue: emailValue,
//     patientsName: patientsName,
//     date: date,
//     whyLossWeight: whyLossWeight,
...
// export async function SubmittedWeightLoss({
//   emailValue,
//   setSubmittedWeightLoss,
// }) {
//   try {
//     onSnapshot(
//       query(
